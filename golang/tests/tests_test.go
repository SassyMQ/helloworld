...
func TestRouting(t *testing.T) {
	...
	programmer.Init("programmer", "amqp://guest:guest@localhost/local")
	// World -
	world := new(TestActor)
	world.Init("world", "amqp://guest:guest@localhost/local")
	// Universe -
	universe := new(TestActor)
	universe.Init("universe", "amqp://guest:guest@localhost/local")

	// Purge Messages in queues
	// Programmer -
	programmer.PurgeListenerQueue()
	// World -
	world.PurgeListenerQueue()
	// Universe -
	universe.PurgeListenerQueue()
	...
	programmer.ListenAndConsume()
	world.ListenAndConsume()
	universe.ListenAndConsume()
